...
export const Projects = () => {
  ...
  return (
    <section className="mx-auto min-w-full px-24 py-20 lg:py-32 lg:px-52 border-b-2 border-b-[#e5e7eb1c] overflow-hidden relative">
      <h2 className="z-10 text-white mb-5 lg:mb-24 text-4xl lg:text-6xl font-extrabold relative">
        My latest Projects
      </h2>
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-[url('/img/projectbg.jpg')] mix-blend-color bg-no-repeat bg-cover [mask-image:linear-gradient(-180deg,transparent,black,transparent)]"></div>
    </section>
  );
};
